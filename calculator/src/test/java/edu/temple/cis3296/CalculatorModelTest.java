...
public class CalculatorModelTest {
	...
	public void shouldSubstTwoAndTwo(){
		assertEquals(0.0, calc.operationMinus(2.0, 2.0), 0.1);
	} 

	@Test
	public void shouldMultTwoByTwo(){
		assertEquals(4.0, calc.operationMult(2.0, 2.0), 0.1);
	} 

	@Test
	public void shouldDivTwoDivTwo(){
